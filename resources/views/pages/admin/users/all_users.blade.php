...
@section('content')      
                      ...
                      <div class="dashboard-data">
                        <div class="row p-2">
                          ...
                          <div class="col d-flex justify-content-end">
                             <form method="POST" action="{{ route('users.searchByEmail') }}" class="form-inline">
                              @csrf
      ...
      function getData (){
                      ...
                      for(let value of users.data){
                        let aOpen='<a class="text-dark" href="/users/'+value.id+'">';
                        let aClose='</a>';
                        
                        chartData.push([aOpen+value.name+aClose, aOpen+value.email+aClose, parseFloat(value.id)]);
          ...
          @include('includes.js.users_table')
