...
<div class="shadow-sm rounded bg-sidebar long-card" >
  ...
  <ul class="list-group list-group-flush bg-sidebar">
    ...
    <li class="list-group-item client-side-menu-hover bg-sidebar">
      <i class="fas fa-check mr-2"></i> <a class="text-whiten font1" href="{{ route('client.settled.orders.list') }}"> Settled orders</a> 
    </li>
    <li class="list-group-item client-side-menu-hover bg-sidebar">
      <i class="fas fa-spinner mr-2"> </i><a class="text-whiten font1" href="{{ route('client.inprogress.orders.list') }}"> In progress</a> 
    </li>
    <li class="list-group-item client-side-menu-hover bg-sidebar">
      <i class="fas fa-hand-holding-usd mr-2"></i> <a class="text-whiten font1" href="{{ route('client.paid.orders.list') }}">Paid orders</a>  
    </li>
    <li class="list-group-item client-side-menu-hover bg-sidebar">
     <i class="fas fa-question mr-2"></i> <a class="text-whiten font1" href="{{ route('client.unpaid.orders.list') }}">Unpaid orders</a>  
    </li>
